<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="add_new_kpi.aspx.cs" Inherits="Balanced_Scorecard.add_new_kpi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Add New KPI | Balanced Scorecard
</asp:Content>
            ...
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b><asp:Label ID="LabelAddRequest" runat="server" Text="Label"></asp:Label> New KPI</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-table"></i>&nbsp;<asp:Label ID="LabelAddRequest2" runat="server" Text="Label"></asp:Label> New KPI</h1>
                        </div>
                    </div>
                <!-- /.row -->
                ...
                <!-- FORM -->
                    <form class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <asp:UpdatePanel ID="UpdatePanelAddNewKPI" runat="server">
                      <ContentTemplate>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <asp:TextBox ID="TextBoxKPI" MaxLength="200" OnTextChanged="OnKPIChanged" AutoPostBack="true" runat="server" placeholder="Your Key Performance Indicator" required="required" CssClass="form-control"></asp:TextBox>
                      ...
                      <div class="form-group">
                        <label for="TextareaObjective" class="col-md-2 col-sm-3 control-label">Objective</label>
                            <div class="col-md-5 col-sm-7">
                              <textarea id="TextareaObjective" maxlength="250" required="required" runat="server" class="form-control" rows="3" placeholder="Type Some Objective"></textarea>
                            </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group" id="ReasonTextBox" style="visibility:hidden;position:absolute" runat="server">
                        <label for="TextareaObjective" class="col-md-2 col-sm-3 control-label">Reason</label>
                            <div class="col-md-5 col-sm-7">
                              <textarea id="TextAreaReason" maxlength="250" runat="server" class="form-control" rows="3" placeholder="Why you want to add this new KPI?"></textarea>
                            </div>
                      </div>
                      <div class="form-group">
                      	<div class="col-md-offset-2 col-md-10 col-sm-offset-3">
                            	<a runat="server" id="cancel_add_new_KPI" class="btn btn-primary btn-cancel-group"><i class="fa fa fa-reply"></i>&nbsp;&nbsp;Cancel Add&nbsp;&nbsp;</a>
                              <span style="color:white" id="SpanAddGroup" runat="server">
                                <i id="FontAwesomeIcon" runat="server"></i>
                                  <asp:Button BackColor="Transparent" BorderColor="Transparent" ID="ButtonAddKPI" OnClick="OnClickAddKPI" runat="server" />
                              </span>
                        </div>
                      </div>
                      </ContentTemplate>
