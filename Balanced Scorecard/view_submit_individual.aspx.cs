...
{
    public partial class view_submit_individual : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                var prev_page = Request.QueryString["prev_page"];//agar kembali ke halaman Submitted Scorecard yang sama ketika Back
                ...
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "");
                ...
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&nik=" + nik + "");
                    btnBackToSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&nik=" + nik + "");
                }
                else if (nik == null && org != null && adt_org == null && bsc_group == null && name == null)
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&organization=" + org + "");
                    btnBackToSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&organization=" + org + "");
                }
                else if (nik == null && org == null && adt_org != null && bsc_group == null && name == null)
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&adt_organization=" + adt_org + "");
                ...
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&bsc_group=" + bsc_group + "");
                    btnBackToSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&bsc_group=" + bsc_group + "");
                }
                else if (nik == null && org == null && adt_org == null && bsc_group == null && name != null)
                {
                    hrefSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&name=" + name + "");
                    btnBackToSubmitUsers.Attributes.Add("href", "view_submit_users.aspx?page=" + prev_page + "&period_id=" + periode_id + "&name=" + name + "");
                }

                hrefDashboard.Attributes.Add("href", "dashboard.aspx?period_id=" + periode_id + "");
                ...
                using (SqlConnection conn = new SqlConnection(str_connect))
                {
                    ...
                    string string_get_user_stretch_and_review = "SELECT FinancialHeader_IndividualStretchRating, FinancialHeader_Review FROM ScorecardUser "
                                                               ...
                                                               + "WHERE ScorecardUser.EmpId='" + emp_nik + "' AND FinancialMeasures_Header.Period_ID=" + periode_id + "";
                    ...
                    SqlCommand sql_get_user_stretch_and_review = new SqlCommand(string_get_user_stretch_and_review, conn);
                    ...
                    using (SqlDataReader ReviewStretchReader = sql_get_user_stretch_and_review.ExecuteReader())
                    {
                        if (ReviewStretchReader.HasRows)
                        {
                            while (ReviewStretchReader.Read())
                            {
                                LabelReview.Text = ReviewStretchReader["FinancialHeader_Review"].ToString();
                                LabelStretchRating.Text = ReviewStretchReader["FinancialHeader_IndividualStretchRating"].ToString() + "%";
                            }
                        }
                        else
                        {
                        ...
                        ReviewStretchReader.Dispose();
                        ReviewStretchReader.Close();
                    }
                    ...
                    //asumsi NIK = 100
                    string get_max_data = "SELECT COUNT(IndividualHeader_ID) FROM IndividualMeasures_Header "
                                        + "join ScorecardUser ON ScorecardUser.user_id = IndividualMeasures_Header.user_id "
                                        + "WHERE IndividualMeasures_Header.Period_ID=" + periode_id + " AND IndividualMeasures_Header.data_status='exist' "
                                        + "AND ScorecardUser.EmpId='" + emp_nik + "'";
                    string select_individual_header = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY Period_ID ASC) AS rowNum, "
                                                    + "IndividualHeader_KPI, IndividualHeader_Target, "
                                                    + "IndividualHeader_Result, IndividualHeader_Formula, IndividualHeader_Rating, IndividualHeader_MeasureBy, "
                                                    + "IndividualHeader_Weight, IndividualHeader_Objective, IndividualHeader_Score, IndividualHeader_ID FROM IndividualMeasures_Header "
                                                    + "join ScorecardUser ON ScorecardUser.user_id=IndividualMeasures_Header.user_id "
                                                    + "WHERE IndividualMeasures_Header.Period_ID=" + periode_id + " AND IndividualMeasures_Header.data_status='exist' "
                                                    + "AND ScorecardUser.EmpId='" + emp_nik + "')sub "
                    ...
                    using (SqlDataReader IndividualHeaderReader = sql_select_individual_header.ExecuteReader())
                    {
                        if (IndividualHeaderReader.HasRows)
                        {
                            ...
                            while (IndividualHeaderReader.Read())
                            {
                                ...
                                if (int.Parse(IndividualHeaderReader["IndividualHeader_Target"].ToString()) == -1)
                                {
                                    HtmlTableData.Append("<a class='btn btn-default disabled' href='#'>Update KPI</a>");
                                }
                                else
                                {
                                    HtmlTableData.Append("<a class='btn btn-default' href='edit_submit_kpi.aspx?page=" + page + "&header_id=" + IndividualHeaderReader["IndividualHeader_ID"] + "&period_id=" + periode_id + "&prev_page=" + prev_page + "&emp_nik=" + emp_nik + "'>Update KPI</a>");
                                }
                                ...
                                if (specific_objective != null)//jika ada specific objective
                                {
                                    using (SqlDataReader SpecificReader = sql_select_individual_detail.ExecuteReader())
                                    {
                                        ...
                                        while (SpecificReader.Read())
                                        {
                                            ...
                                            HtmlTableData.Append("<td class='td-align'><a href='edit_submit_specific.aspx?page=" + page + "&header_id=" + IndividualHeaderReader["IndividualHeader_ID"] + "&detail_id=" + SpecificReader["IndividualDetail_ID"] + "&period_id=" + periode_id + "&prev_page=" + prev_page + "&emp_nik="+emp_nik+"' class='btn btn-default'>Update</a></td>");
                                            HtmlTableData.Append("</tr>");
            ...
            using (SqlConnection conn = new SqlConnection(str_connect))
            {
                ...
                using (SqlDataReader HeaderReader = sql_select_group_info.ExecuteReader())
                {
                    while (HeaderReader.Read())
                    {
                        ...
                        //ASUMSI --> NIK=100
                        string string_select_individual_header = "SELECT * FROM IndividualMeasures_Header join ScorecardUser ON ScorecardUser.user_id = IndividualMeasures_Header.user_id "
                                                               + "WHERE IndividualMeasures_Header.Period_ID=" + period_id + " AND IndividualMeasures_Header.data_status='exist' "
                                                               + "AND ScorecardUser.EmpId='" + emp_nik + "'";
        ...
        protected void OnClickExportExcel(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(str_connect))
            {
                                ...
                                if (ShareZeroReader.HasRows)
                                {
                                    while (ShareZeroReader.Read())
                                    {
                                        ...
                                        else
                                        {
                                            if (ShareZeroReader["FinancialMeasureBy"].ToString() == "Numbers")
                                            {
                                                HttpContext.Current.Response.Write("<td align='center' style='vertical-align:middle'>" + ShareZeroReader["FinancialTarget"] + "</td>");
                                                HttpContext.Current.Response.Write("<td align='center' style='vertical-align:middle'>" + ShareZeroReader["FinancialResult"] + "</td>");
                                            }
                                            else
                                            {
                ...
                string string_select_individual_header = "SELECT * FROM IndividualMeasures_Header join ScorecardUser ON ScorecardUser.user_id = IndividualMeasures_Header.user_id "
                                                       + "WHERE Period_ID=" + period_id + " AND data_status='exist' AND ScorecardUser.EmpId=" + emp_nik + "";
                SqlCommand sql_select_individual_header = new SqlCommand(string_select_individual_header, conn);
                using (SqlDataReader IndividualHeaderReader = sql_select_individual_header.ExecuteReader())
                {
                    HttpContext.Current.Response.Write("<tr>");
