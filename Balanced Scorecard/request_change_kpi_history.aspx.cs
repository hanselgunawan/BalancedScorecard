...
{
    public partial class request_change_kpi_history : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                string get_max_data = "", select_all_header_history="";
                ...
                string string_check_access_page = "SELECT Access_Rights_Code FROM GroupAccessRights "//untuk cek, apakah dia boleh akses halaman ini
                                                + "WHERE Access_Rights_Code='request_change_kpi_history' AND "//jika diakses secara paksa
                ...
                using (SqlConnection conn = new SqlConnection(str_connect))
                {
                    ...
                    using (SqlDataReader PeriodReader = sql_command_all.ExecuteReader())//UNTUK VIEW SEMUA PERIODE YANG ADA
                    {
                        ...
                        if (PeriodReader.HasRows)
                        {
                            while (PeriodReader.Read())
                            {
                                ...
                                enddate_to_date = end_date.ToString("MMM yyyy");//ubah format tanggal!
                                start_end_date = startdate_to_date + " - " + enddate_to_date;
                                HtmlDropdown.Append("<li role='presentation'><a role='menuitem' href='request_change_kpi_history.aspx?period_id=" + PeriodReader["Period_ID"] + "'>");
                    ...
                    {
                        get_max_data = "SELECT COUNT(IndividualHeaderRequest_ID) FROM IndividualHeader_RequestChange WHERE Period_ID=" + period_id + "";
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 + "AS rowNum, t1.IndividualHeader_KPI, t1.EmpId, t1.empName, t2.EmpId Superior_NIK, "
                                                 + "t2.empName Superior_Name, t1.IndividualHeaderRequest_ID, t1.Approval_Status, t1.date_create, t1.date_update, "
                                                 + "t1.OrgName, t1.OrgAdtGroupName, t1.delete_flag FROM "
                                                 + "(SELECT IndividualHeaderHistory.IndividualHeader_KPI, ScorecardUser.EmpId, ScorecardUser.empName, "
                                                 + "OrgName, OrgAdtGroupName, "
                                                 + "IndividualHeader_RequestChange.Approval_Status, IndividualHeader_RequestChange.delete_flag, "
                                                 + "IndividualHeader_RequestChange.IndividualHeaderRequest_ID, IndividualHeader_RequestChange.Period_ID, IndividualHeader_RequestChange.date_create, "
                                                 + "IndividualHeader_RequestChange.date_update, IndividualHeader_RequestChange.user_id FROM IndividualHeader_RequestChange "
                                                 + "join ScorecardUser ON IndividualHeader_RequestChange.user_id = ScorecardUser.user_id "
                                                 + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID "
                                                 ...
                                                 + "LEFT JOIN "
                                                 + "(SELECT DISTINCT IndividualHeader_RequestChange.user_id, ScorecardUser.EmpId, ScorecardUser.empName FROM IndividualHeader_RequestChange "
                                                 + "join ScorecardUser ON IndividualHeader_RequestChange.Superior_ID = ScorecardUser.EmpId "
                                                 + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID) t2 "
                    ...
                    else if (req_nik != null && req_name == null && req_org == null && req_adt_org == null && app_nik == null && app_name == null)
                    {
                        ...
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 ...
                                                 + "IndividualHeader_RequestChange.Approval_Status, IndividualHeader_RequestChange.delete_flag, "
                                                 + "IndividualHeader_RequestChange.IndividualHeaderRequest_ID, IndividualHeader_RequestChange.Period_ID, IndividualHeader_RequestChange.date_create, "
                                                 + "IndividualHeader_RequestChange.date_update FROM IndividualHeader_RequestChange "
                                                 + "join ScorecardUser ON IndividualHeader_RequestChange.user_id = ScorecardUser.user_id "
                                                 + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID "
                                                 + "join [Human_Capital_demo].dbo.Organization on ScorecardUser.empOrgCode = Organization.OrgCode "
                                                 + "join ScorecardGroupLink ON ScorecardUser.empOrgAdtGroupCode = ScorecardGroupLink.OrgAdtGroupCode AND ScorecardGroupLink.Period_ID=" + period_id + ") t1 "
                                                 + "LEFT JOIN "
                                                 + "(SELECT DISTINCT IndividualHeaderHistory.IndividualHeader_KPI, ScorecardUser.EmpId, ScorecardUser.empName FROM IndividualHeader_RequestChange "
                                                 + "join ScorecardUser ON IndividualHeader_RequestChange.Superior_ID = ScorecardUser.EmpId "
                                                 + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID) t2 "
                                                 + "ON t1.IndividualHeader_KPI = t2.IndividualHeader_KPI "
                    ...
                    else if (req_nik == null && req_name != null && req_org == null && req_adt_org == null && app_nik == null && app_name == null)
                    {
                        get_max_data = "SELECT COUNT(IndividualHeaderRequest_ID) FROM IndividualHeader_RequestChange "
                                     + "join ScorecardUser ON IndividualHeader_RequestChange.user_id = ScorecardUser.user_id "
                                     + "WHERE IndividualHeader_RequestChange.Period_ID=" + period_id + " AND ScorecardUser.empName LIKE '" + req_name + "%'";
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 + "AS rowNum, t1.IndividualHeader_KPI, t1.EmpId, t1.empName, t2.EmpId Superior_NIK, "
                                                 + "t2.empName Superior_Name, t1.IndividualHeaderRequest_ID, t1.Approval_Status, t1.date_create, t1.date_update, "
                                                 + "t1.OrgName, t1.OrgAdtGroupName, t1.delete_flag FROM "
                    ...
                    else if (req_nik == null && req_name == null && req_org != null && req_adt_org == null && app_nik == null && app_name == null)
                    {
                        get_max_data = "SELECT COUNT(IndividualHeaderRequest_ID) FROM IndividualHeader_RequestChange "
                                     + "join ScorecardUser ON IndividualHeader_RequestChange.user_id = ScorecardUser.user_id "
                                     + "join [Human_Capital_demo].dbo.Organization on ScorecardUser.empOrgCode = Organization.OrgCode "
                                     + "WHERE IndividualHeader_RequestChange.Period_ID=" + period_id + " AND OrgName LIKE '" + req_org + "%'";
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 + "AS rowNum, t1.IndividualHeader_KPI, t1.EmpId, t1.empName, t2.EmpId Superior_NIK, "
                                                 + "t2.empName Superior_Name, t1.IndividualHeaderRequest_ID, t1.Approval_Status, t1.date_create, t1.date_update, "
                                                 + "t1.OrgName, t1.OrgAdtGroupName, t1.delete_flag FROM "
                                                 ...
                                                 + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID) t2 "
                                                 + "ON t1.IndividualHeader_KPI = t2.IndividualHeader_KPI "
                                                 + "WHERE t1.Period_ID=" + period_id + " AND t1.OrgName LIKE '" + req_org + "%')sub "
                                                 + "WHERE rowNum>=((" + page + "-1)*" + data_per_page + ")+1 AND rowNum<=" + data_per_page + "*" + page + "";
                    ...
                    else if (req_nik == null && req_name == null && req_org == null && req_adt_org != null && app_nik == null && app_name == null)
                    {
                        get_max_data = "SELECT COUNT(IndividualHeaderRequest_ID) FROM IndividualHeader_RequestChange "
                                     ...
                                     + "WHERE IndividualHeader_RequestChange.Period_ID=" + period_id + " AND OrgAdtGroupName LIKE '" + req_adt_org + "%'";
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 + "AS rowNum, t1.IndividualHeader_KPI, t1.EmpId, t1.empName, t2.EmpId Superior_NIK, "
                                                 + "t2.empName Superior_Name, t1.IndividualHeaderRequest_ID, t1.Approval_Status, t1.date_create, t1.date_update, "
                                                 + "t1.OrgName, t1.OrgAdtGroupName, t1.delete_flag FROM "
                    ...
                    {
                        get_max_data = "SELECT COUNT(IndividualHeaderRequest_ID) FROM IndividualHeader_RequestChange WHERE Period_ID=" + period_id + " AND Superior_ID LIKE '" + app_nik + "%'";
                        select_all_header_history = "SELECT * FROM (SELECT ROW_NUMBER() OVER(ORDER BY CAST(t1.EmpId AS int) ASC, t1.date_create DESC) "
                                                 + "AS rowNum, t1.IndividualHeader_KPI, t1.EmpId, t1.empName, t2.EmpId Superior_NIK, "
                                                 + "t2.empName Superior_Name, t1.IndividualHeaderRequest_ID, t1.Approval_Status, t1.date_create, t1.date_update, "
                                                 + "t1.OrgName, t1.OrgAdtGroupName, t1.delete_flag FROM "
                    ...
                    SqlCommand sql_select_all_header_history = new SqlCommand(select_all_header_history, conn);
                    ...
                    using (SqlDataReader RequestReader = sql_select_all_header_history.ExecuteReader())
                    {
                        if (RequestReader.HasRows)
                        {
                            ...
                            HtmlApprovalTable.Append("<th class='centering-th-period' style='width:150px'>Previous KPI</th>");
                            HtmlApprovalTable.Append("<th class='centering-th-period' style='width:150px'>Request For</th>");
                            ...
                            HtmlApprovalTable.Append("<th class='centering-th-period'>Approved Date</th>");
                            ...
                            while (RequestReader.Read())
                            {
                                ...
                                if (req_nik == null && req_name == null && req_org == null && req_adt_org == null && app_nik == null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "'>See Details</a></td>");
                                }
                                else if (req_nik != null && req_name == null && req_org == null && req_adt_org == null && app_nik == null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&req_nik="+req_nik+"'>See Details</a></td>");
                                }
                                else if (req_nik == null && req_name != null && req_org == null && req_adt_org == null && app_nik == null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&req_name="+req_name+"'>See Details</a></td>");
                                }
                                else if (req_nik == null && req_name == null && req_org != null && req_adt_org == null && app_nik == null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&req_org="+req_org+"'>See Details</a></td>");
                                }
                                else if (req_nik == null && req_name == null && req_org == null && req_adt_org != null && app_nik == null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&req_adt_org="+req_adt_org+"'>See Details</a></td>");
                                }
                                else if (req_nik == null && req_name == null && req_org == null && req_adt_org == null && app_nik != null && app_name == null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&app_nik="+app_nik+"'>See Details</a></td>");
                                }
                                else if (req_nik == null && req_name == null && req_org == null && req_adt_org == null && app_nik == null && app_name != null)
                                {
                                    HtmlApprovalTable.Append("<td class='td-align'><a href='view_kpi_history_detail.aspx?page=" + page + "&request_id=" + RequestReader["IndividualHeaderRequest_ID"] + "&period_id=" + period_id + "&app_name="+app_name+"'>See Details</a></td>");
                                }
                                ...
                                HtmlApprovalTable.Append("<td class='td-align' style='width:120px'>" + request_date + "</td>");
                                HtmlApprovalTable.Append("<td class='td-align' style='width:120px'>" + approve_date + "</td>");
        ...
        protected void OnClickSearch(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?period_id=" + period_id + "");
            }
            else
            {
                if (DropDownListSearchBy.SelectedIndex == 0)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?req_nik=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
                else if (DropDownListSearchBy.SelectedIndex == 1)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?req_name=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
                else if (DropDownListSearchBy.SelectedIndex == 2)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?req_org=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
                else if (DropDownListSearchBy.SelectedIndex == 3)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?req_adt_org=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
                else if (DropDownListSearchBy.SelectedIndex == 4)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?app_nik=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
                else if (DropDownListSearchBy.SelectedIndex == 5)
                {
                    Response.Redirect("" + baseUrl + "request_change_kpi_history.aspx?app_name=" + TextBoxSearch.Value + "&period_id=" + period_id + "");
                }
            }
        }
            ...
            using (SqlConnection conn = new SqlConnection(str_connect))
            {
                string string_select_KPI_change_request = "SELECT t1.EmpId, t1.empName, t1.OrgName, "
                                                        ...
                                                        + "( "
                                                            ...
                                                            + "IndividualHeader_RequestChange.delete_flag, IndividualHeader_RequestChange.user_id, "
                                                            ...
                                                            + "IndividualHeader_RequestChange.date_update Approved_Date, IndividualHeader_RequestChange.Approval_Status "
                                                            + "FROM ScorecardUser "
                                                        ...
                                                        + "LEFT JOIN "
                                                        + "( "
                                                            + "SELECT DISTINCT IndividualHeader_RequestChange.user_id, ScorecardUser.EmpId Superior_NIK, "
                                                            + "ScorecardUser.empName Superior_Name FROM IndividualHeader_RequestChange  "
                                                            + "join ScorecardUser ON IndividualHeader_RequestChange.Superior_ID = ScorecardUser.EmpId "
                                                            + "join IndividualHeaderHistory ON IndividualHeader_RequestChange.IndividualHeaderRequest_ID = IndividualHeaderHistory.IndividualHeaderRequest_ID "
                                                        + ") t2 "
                                                        + "ON t1.user_id = t2.user_id "
                                                        + "ORDER BY CAST(t1.EmpId AS int) ASC, t1.Request_Date DESC, t1.Group_Name ASC";
                conn.Open();
