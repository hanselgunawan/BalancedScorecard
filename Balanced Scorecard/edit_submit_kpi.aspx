<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="edit_submit_kpi.aspx.cs" Inherits="Balanced_Scorecard.edit_submit_kpi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Update Submitted Individual KPI | Balanced Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Update <asp:Label ID="LabelBreadcrumb" runat="server" Text="Label"></asp:Label>'s KPI</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-table"></i>&nbsp;Update <asp:Label ID="LabelTitle" runat="server" Text="Header"></asp:Label>'s KPI</h1>
                        </div>
                    </div>
                <!-- /.row -->
                    ...
                    <form id="Form1" class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <asp:DropDownList ID="DropDownListSpecific" CssClass="form-control" runat="server"></asp:DropDownList>
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="TextBoxKPI" class="col-md-2 col-sm-3 control-label">KPI</label>
                        <div class="col-md-6 col-sm-8">
                          <input type="text" class="form-control" maxlength="200" id="TextBoxKPI" runat="server" placeholder="Your Key Performance Indicator" required="required" />
                      ...
                      <div class="form-group">
                      	<div class="col-md-offset-2 col-sm-offset-3 col-sm-10">
                            	<a runat="server" id="cancel_add_new_KPI" class="btn btn-primary btn-cancel-group"><i class="fa fa fa-reply"></i>&nbsp;&nbsp;Cancel Update&nbsp;&nbsp;</a>
                              <span style="color:white; width:100px" class="btn btn-add-group btn-add-group-container add-button" id="SpanEditKPI" runat="server">
                                <i class="fa fa-fw fa-pencil-square-o"></i>
                                  <asp:Button BackColor="Transparent" style="width:100px" BorderColor="Transparent" ID="ButtonAddKPI" CssClass="relative-to-btn" OnClick="OnClickEditKPI" Text="Update" runat="server" />
                              </span>
                        </div>
                      </div>
                      </ContentTemplate>
