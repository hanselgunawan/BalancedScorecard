                    ...
                    <form id="Form1" class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <asp:TextBox ID="TextBoxKPI" MaxLength="200" OnTextChanged="OnKPIChanged" AutoPostBack="true" runat="server" CssClass="form-control" placeholder="Your Key Performance Indicator" required="required"></asp:TextBox>
