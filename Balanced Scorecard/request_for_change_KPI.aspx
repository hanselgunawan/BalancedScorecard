                    ...
                    <form id="Form1" class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <asp:TextBox ID="TextBoxKPI" MaxLength="200" OnTextChanged="OnKPIChanged" AutoPostBack="true" CssClass="form-control" placeholder="Your Key Performance Indicator" required="required" runat="server"></asp:TextBox>
                      ...
                      <div class="form-group">
                        <label for="TextBoxRating" class="col-md-2 col-sm-3 control-label">Rating</label>
                              <div class="col-md-3 col-sm-5">
                                  ...
                                  <input readonly="true" type="number" step="0.01" class="form-control" id="TextBoxRating" runat="server" value="0" required="required" />
                      ...
                      <div class="form-group">
                        <label for="TextBoxScore" class="col-md-2 col-sm-3 control-label">Score</label>
                              <div class="col-md-3 col-sm-5">
                                  <div class="input-group">
                                  <input readonly="true" type="number" max="100" step="0.01" class="form-control" id="TextBoxScore" runat="server" value="0" required="required"/>
                                  <div class="input-group-addon">%</div>
                                  </div>
                              </div>
                      </div>
                      <div class="form-group">
                        <label for="TextareaObjective" class="col-md-2 col-sm-3 control-label">Reason</label>
                            <div class="col-md-5 col-sm-7">
                              <textarea id="TextareaReason" maxlength="250" required="required" runat="server" class="form-control" rows="3" placeholder="Why you request for change this KPI?"></textarea>
                            </div>
                      </div>
                      <div class="form-group">
