...
namespace Balanced_Scorecard
{
    public partial class delete_single_specific_objective : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "redirect", "alert('Delete " + spec_obj + " Success!'); window.location='" + baseUrl + "individual_scorecard.aspx?page=" + page + "&id=" + period_id + "';", true);
        }
