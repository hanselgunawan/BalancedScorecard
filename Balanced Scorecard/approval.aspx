<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="approval.aspx.cs" Inherits="Balanced_Scorecard.approval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Approve Request for Change | Balanced Scorecard 
</asp:Content>
            ...
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                        	...
                        	<h1><i class="fa fa fa-list"></i>&nbsp;Respond Individual KPI Add/Change/Delete Requests</h1>
                        </div>
                    </div>
                <!-- /.row -->
