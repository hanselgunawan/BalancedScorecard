                    ...
                    <form class="form-horizontal" runat="server" style="margin-top:20px">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-3 col-sm-5">
                                ...
                                <p class="period-error-message" id="less_than_error_message" runat="server">Must Greater Than Start Period</p>
                        </div>
                        <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <textarea class="form-control" runat="server" rows="3" id="description" placeholder="Type Some Description"></textarea>
                        </div>
                      </div>
                      <div class="form-group">
