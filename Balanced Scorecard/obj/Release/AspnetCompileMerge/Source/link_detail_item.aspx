...
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Link Share Item | Financial Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Link Share Item in <asp:Label ID="LabelBreadcrumb" runat="server" Text="Bread"></asp:Label></b></li>
    						</ol>
                        	<h1><i class="fa fa fa-link"></i>&nbsp;Link Share Item in <asp:Label ID="LabelTitle" runat="server" Text="Title"></asp:Label></h1>
                        </div>
                    </div>
                    ...
                    <div class="row link-row">
                        <div class="col-xs-5 col-md-5">
                            <div class="panel panel-primary">
                            	<div class="panel-heading bold-heading">Share Item:</div>
                        ...
                        <div class="col-xs-5 col-md-5">
                            <p class="error-message-link" id="ErrorMessageLink" runat="server">Share item should be more than one</p>
                            <div class="panel panel-primary">
                            	<div class="panel-heading bold-heading">Link Share Item:</div>
