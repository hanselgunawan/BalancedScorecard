...
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit Submitted Individual KPI | Balanced Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Edit <asp:Label ID="LabelBreadcrumb" runat="server" Text="Label"></asp:Label>'s KPI</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-table"></i>&nbsp;Edit <asp:Label ID="LabelTitle" runat="server" Text="Header"></asp:Label>'s KPI</h1>
                        </div>
                    </div>
                <!-- /.row -->
                    ...
                    <form id="Form1" class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <input type="text" class="form-control" id="TextBoxKPI" runat="server" placeholder="Your Key Performance Indicator" required="required" />
                      ...
                      <div class="form-group">
                      	<div class="col-md-offset-2 col-sm-offset-3 col-sm-10">
                              ...
                              <span style="color:white" class="btn btn-add-group btn-add-group-container add-button" id="SpanEditKPI" runat="server">
                                <i class="fa fa-fw fa-pencil-square-o"></i>
                                  <asp:Button BackColor="Transparent" BorderColor="Transparent" ID="ButtonAddKPI" CssClass="relative-to-btn" OnClick="OnClickEditKPI" Text="Edit" runat="server" />
                              </span>
                        </div>
                      </div>
                      </ContentTemplate>
