<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="request_change_specific_objective_history.aspx.cs" Inherits="Balanced_Scorecard.request_change_specific_objective_history" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Specific Objectives CR History | Balanced Scorecard
</asp:Content>
            ...
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Specific Objective Requests History</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-list"></i>&nbsp;Specific Objective Requests History</h1>
                        </div>
                    </div>
                <!-- /.row -->
                <form class="form-horizontal" id="PeriodForm" style="margin-top:20px" runat="server">
                        ...
                        <ContentTemplate>
                            <div class="row" style="margin-bottom:20px">
                                ...
                                <div class="col-xs-5 col-sm-5 col-md-5">
                                    <asp:Button CssClass="btn btn-success form-control" ID="ButtonExcel" runat="server" Text="Recap All Specific Obj. Add/Change/Delete Request" OnClick="OnClickExportExcel"/>
                                </div>
                            </div>
                            <div class="row">
					...
					<div class="panel panel-primary" id="panel_csc">
                        	<div class="panel-heading"><p class="csc_p">History of Specific Objective Change Requests</p></div>
