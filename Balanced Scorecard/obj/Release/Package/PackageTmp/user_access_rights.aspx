                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:Balanced ScorecardConnectionString %>" SelectCommand="SELECT [UserGroup_ID], [Group_Name] FROM [BSC_UserGroup]"></asp:SqlDataSource>
                                        </td>
                                    </tr>
                                </table>  
