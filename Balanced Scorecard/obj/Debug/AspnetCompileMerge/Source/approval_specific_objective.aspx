<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="approval_specific_objective.aspx.cs" Inherits="Balanced_Scorecard.approval_specific_objective" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Change Requests for Individual KPI's Specific Objective | Balanced Scorecard
</asp:Content>
            ...
            <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                        	...
                        	<h1><i class="fa fa fa-list"></i>&nbsp;Respond Individual KPI's Specific Objective Add/Change/Delete Requests</h1>
                        </div>
                    </div>
                <!-- /.row -->
                        ...
                        <ContentTemplate>
                            <div class="row" style="margin-bottom:20px">
                                ...
                                <div class="col-xs-5 col-sm-5 col-md-5">
                                    <asp:Button CssClass="btn btn-success form-control" ID="ButtonExcel" runat="server" Text="Recap All Spec. Objective Add/Change/Delete Request" OnClick="OnClickExportExcel"/>
                                </div>
                            </div>
                            <div class="row">
