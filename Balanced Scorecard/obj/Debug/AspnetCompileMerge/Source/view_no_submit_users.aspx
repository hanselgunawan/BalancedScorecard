<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="view_no_submit_users.aspx.cs" Inherits="Balanced_Scorecard.view_no_submit_users" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View Not Submit Users | Balanced Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>View Not Submit Users</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-user"></i>&nbsp;View Not Submit Users</h1>
                        </div>
                    </div>
                <!-- /.row -->
                    <a id="hrefBackToDashboard" class="btn btn-primary" runat="server" style="margin-top:0px; margin-bottom:-135px"><i class="fa fa fa-reply"></i>&nbsp;Back to Dashboard</a>
                      ...
                      <div class="col-xs-5 col-md-5">
                          <div class="input-group">
                              ...
                              <span class="input-group-btn">
                                  <asp:Button ID="Button1" OnClick="OnClickSearch" runat="server" CssClass="btn btn-search" Text="Search" />
                              </span>
                          </div>
                      </div>
                    </div>
