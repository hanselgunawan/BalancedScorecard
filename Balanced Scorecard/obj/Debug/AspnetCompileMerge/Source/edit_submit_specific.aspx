...
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    Edit Submitted Specific Objective | Balanced Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Edit <asp:Label ID="LabelBreadcrumb" runat="server" Text="Label"></asp:Label>'s Spec. Objective</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-table"></i>&nbsp;Edit <asp:Label ID="LabelTitle" runat="server" Text="Header"></asp:Label>'s Spec. Objective</h1>
                        </div>
                    </div>
                <!-- /.row -->
                    ...
                    <form id="Form1" class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <input type="text" class="form-control" runat="server" id="TextBoxSpecificObjective" placeholder="Your Specific Objective" required="required"/>
                      ...
                      <div class="form-group">
                      	<div class="col-sm-offset-2 col-sm-10">
                      		<p>
                                ...
                                <span style="color:white" id="SpanEditSpecific" runat="server" class="btn btn-success btn-add-group btn-add-group-container edit-button">
                                <i class="fa fa-fw fa-pencil-square-o"></i>
                                  <asp:Button BackColor="Transparent" BorderColor="Transparent" ID="ButtonEditDetail" CssClass="relative-to-edit-btn" OnClick="OnClickEditSpecific" runat="server" Text="Edit" />
                                </span>
                            </p>
                        </div>
                      </div>
