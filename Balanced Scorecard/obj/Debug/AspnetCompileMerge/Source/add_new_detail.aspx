                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><b>Add New Item (<asp:Label ID="LabelBreadcrumb" runat="server" Text="Breadcrumb"></asp:Label>)</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-table"></i>&nbsp;Add New Item (<asp:Label ID="LabelTitle" runat="server" Text="Title"></asp:Label>)</h1>
                        </div>
                    </div>
                <!-- /.row -->
                    ...
                    <form class="form-horizontal" runat="server" style="margin-top:20px">
                      ...
                      <div class="form-group">
                        <label for="TextBoxResult" class="col-md-2 col-sm-3 control-label">Result</label>
                            <div class="col-md-3 col-sm-5">
                           		<input type="number" runat="server" min="0" class="form-control" required="required" id="TextBoxResult" value="0"/>                            	
                            </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        <label for="TextBoxRating" class="col-md-2 col-sm-3 control-label">Rating</label>
                              <div class="col-md-3 col-sm-5">
                                  ...
                                  <input type="number" runat="server" min="0" required="required" max="150" step="0.01" class="form-control" id="TextBoxRating" value="0"/>
                      	...
                      	<div class="col-md-offset-2 col-sm-offset-3 col-sm-10">
                      		<p>
                                ...
                                <i class="fa fa-fw fa-thumbs-o-up"></i>
                                  <asp:Button BackColor="Transparent" BorderColor="Transparent" ID="Button1" CssClass="relative-to-btn" OnClick="OnClickAddDetail" runat="server" Text="Done" />
                                </span>
                            </p>
                        </div>
                      </div>
