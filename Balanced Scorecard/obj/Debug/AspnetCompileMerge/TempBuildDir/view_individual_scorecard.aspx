<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="view_individual_scorecard.aspx.cs" Inherits="Balanced_Scorecard.view_individual_scorecard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View Individual Scorecard | Balanced Scorecard
</asp:Content>
					...
					<div class="panel panel-primary" id="panel_csc">
                                ...
                                <table>
                                    <tr>
                            	        ...
                            	        <td style="border-right:1px solid white; border-left:1px solid white; padding-right:20px"><span style="margin-left:20px"><b>Stretch Rating: </b>150%</span></td>
                                        <td><span style="margin-left:20px"><b>Review: </b>Quarterly</span></td>
                                    </tr>
                                </table>
                            </div>
