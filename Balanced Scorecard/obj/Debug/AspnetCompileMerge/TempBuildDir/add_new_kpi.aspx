                    ...
                    <form class="form-horizontal" style="margin-top:20px" runat="server">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-8">
                          <asp:TextBox ID="TextBoxKPI" OnTextChanged="OnKPIChanged" AutoPostBack="true" runat="server" placeholder="Your Key Performance Indicator" required="required" CssClass="form-control"></asp:TextBox>
                      ...
                      <div class="form-group">
                        <label for="TextBoxResult" class="col-md-2 col-sm-3 control-label">Result</label>
                            <div class="col-md-3 col-sm-4">
                           		<input type="number" min="0" class="form-control" id="TextBoxResult" runat="server" value="0" required="required"/>                            	
                            </div>
                      </div>
                      <div class="form-group">
