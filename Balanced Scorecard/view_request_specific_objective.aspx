<%@ Page Title="" Language="C#" MasterPageFile="~/BSC.Master" AutoEventWireup="true" CodeBehind="view_request_specific_objective.aspx.cs" Inherits="Balanced_Scorecard.view_request_specific_objective" %>
<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    View Request for Change Individual KPI's Specific Objective | Balanced Scorecard
</asp:Content>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <ol class="breadcrumb" id="breadcrumb-csc">
                              ...
                              <li><a runat="server" id="breadcrumb_kpi_approval">Specific Objectives</a></li>
                              <li><b>View Specific Objective Request Details</b></li>
    						</ol>
                        	<h1><i class="fa fa fa-list"></i>&nbsp;View Specific Objective Request Details</h1>
                        </div>
                    </div>
                <!-- /.row -->
                <a id="hrefBackToKPIApproval" class="btn btn-primary" runat="server" style="margin-top:10px"><i class="fa fa fa-reply"></i>&nbsp;Back to Specific Objective Add/Change/Delete Request</a>
                    <div class="row">
